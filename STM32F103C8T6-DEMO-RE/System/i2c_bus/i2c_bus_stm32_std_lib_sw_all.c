...
#define __SDA_GPIO_CLK		RCC_APB2Periph_GPIOB
#define __SDA_GPIO_PIN		GPIO_Pin_9
#define __SDA_GPIO_PORT		GPIOB

#define __SCL_HIGH()		GPIO_SetBits(__SCL_GPIO_PORT, __SCL_GPIO_PIN)
#define __SCL_LOW()			GPIO_ResetBits(__SCL_GPIO_PORT, __SCL_GPIO_PIN)
#define __SCL_READ()		GPIO_ReadInputDataBit(__SCL_GPIO_PORT, __SCL_GPIO_PIN)
#define __SCL_WRITE(X)		GPIO_WriteBit(__SCL_GPIO_PORT, __SCL_GPIO_PIN, X ? Bit_SET : Bit_RESET)

#define __SDA_HIGH()		GPIO_SetBits(__SDA_GPIO_PORT, __SDA_GPIO_PIN)
#define __SDA_LOW()			GPIO_ResetBits(__SDA_GPIO_PORT, __SDA_GPIO_PIN)
...
__STATIC_INLINE void __scl_high(i2c_bus_stm32_std_lib_sw_config_t *cfg) {
	GPIO_SetBits(cfg->scl_gpio_port, cfg->scl_gpio_pin);
}

__STATIC_INLINE void __scl_low(i2c_bus_stm32_std_lib_sw_config_t *cfg) {
...
__STATIC_INLINE void __scl_write(i2c_bus_stm32_std_lib_sw_config_t *cfg, uint8_t BitValue) {
	GPIO_WriteBit(cfg->scl_gpio_port, cfg->scl_gpio_pin, (BitAction)BitValue);
}

__STATIC_INLINE void __sda_high(i2c_bus_stm32_std_lib_sw_config_t *cfg) {
	GPIO_SetBits(cfg->sda_gpio_port, cfg->sda_gpio_pin);
}

__STATIC_INLINE void __sda_low(i2c_bus_stm32_std_lib_sw_config_t *cfg) {
...
__STATIC_INLINE void __sda_write(i2c_bus_stm32_std_lib_sw_config_t *cfg, uint8_t BitValue) {
