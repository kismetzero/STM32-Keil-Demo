...
#define __SCK_GPIO_CLK		RCC_APB2Periph_GPIOB
#define __SCK_GPIO_PIN		GPIO_Pin_8
#define __SCK_GPIO_PORT		GPIOB

#define __MOSI_GPIO_CLK		RCC_APB2Periph_GPIOB
#define __MOSI_GPIO_PIN		GPIO_Pin_9
#define __MOSI_GPIO_PORT	GPIOB

#define __MISO_GPIO_CLK		RCC_APB2Periph_GPIOB
#define __MISO_GPIO_PIN		GPIO_Pin_7
#define __MISO_GPIO_PORT	GPIOB

#define __SCK_HIGH()		GPIO_SetBits(__SCK_GPIO_PORT, __SCK_GPIO_PIN)
#define __SCK_LOW()			GPIO_ResetBits(__SCK_GPIO_PORT, __SCK_GPIO_PIN)
#define __SCK_READ()		GPIO_ReadInputDataBit(__SCK_GPIO_PORT, __SCK_GPIO_PIN)
#define __SCK_WRITE(X)		GPIO_WriteBit(__SCK_GPIO_PORT, __SCK_GPIO_PIN, X ? Bit_SET : Bit_RESET)

#define __MOSI_HIGH()		GPIO_SetBits(__MOSI_GPIO_PORT, __MOSI_GPIO_PIN)
#define __MOSI_LOW()		GPIO_ResetBits(__MOSI_GPIO_PORT, __MOSI_GPIO_PIN)
#define __MOSI_READ()		GPIO_ReadInputDataBit(__MOSI_GPIO_PORT, __MOSI_GPIO_PIN)
#define __MOSI_WRITE(X)		GPIO_WriteBit(__MOSI_GPIO_PORT, __MOSI_GPIO_PIN, X ? Bit_SET : Bit_RESET)

#define __MISO_READ()		GPIO_ReadInputDataBit(__MISO_GPIO_PORT, __MISO_GPIO_PIN)

__STATIC_INLINE void __spi_delay(void) {
	delay_us(5);
}

__STATIC_INLINE void __sck_high(spi_bus_stm32_std_lib_sw_bus_config_t *cfg) {
	GPIO_SetBits(cfg->sck_gpio_port, cfg->sck_gpio_pin);
}

__STATIC_INLINE void __sck_low(spi_bus_stm32_std_lib_sw_bus_config_t *cfg) {
	GPIO_ResetBits(cfg->sck_gpio_port, cfg->sck_gpio_pin);
}
...
__STATIC_INLINE void __mosi_high(spi_bus_stm32_std_lib_sw_bus_config_t *cfg) {
	GPIO_SetBits(cfg->mosi_gpio_port, cfg->mosi_gpio_pin);
}

__STATIC_INLINE void __mosi_low(spi_bus_stm32_std_lib_sw_bus_config_t *cfg) {
	GPIO_ResetBits(cfg->mosi_gpio_port, cfg->mosi_gpio_pin);
}
...
#define __CS_GPIO_CLK		RCC_APB2Periph_GPIOB
#define __CS_GPIO_PIN		GPIO_Pin_8
#define __CS_GPIO_PORT		GPIOB

#define __CS_HIGH()			GPIO_SetBits(__CS_GPIO_PORT, __CS_GPIO_PIN)
#define __CS_LOW()			GPIO_ResetBits(__CS_GPIO_PORT, __CS_GPIO_PIN)
#define __CS_READ()			GPIO_ReadInputDataBit(__CS_GPIO_PORT, __CS_GPIO_PIN)
#define __CS_WRITE(X)		GPIO_WriteBit(__CS_GPIO_PORT, __CS_GPIO_PIN, X ? Bit_SET : Bit_RESET)

__STATIC_INLINE void __cs_high(spi_bus_stm32_std_lib_sw_cs_config_t *cfg) {
	GPIO_SetBits(cfg->cs_gpio_port, cfg->cs_gpio_pin);
}

__STATIC_INLINE void __cs_low(spi_bus_stm32_std_lib_sw_cs_config_t *cfg) {
	GPIO_ResetBits(cfg->cs_gpio_port, cfg->cs_gpio_pin);
}

__STATIC_INLINE uint8_t __cs_read(spi_bus_stm32_std_lib_sw_cs_config_t *cfg) {
	return GPIO_ReadInputDataBit(cfg->cs_gpio_port, cfg->cs_gpio_pin);
}

__STATIC_INLINE void __cs_write(spi_bus_stm32_std_lib_sw_cs_config_t *cfg, uint8_t val) {
